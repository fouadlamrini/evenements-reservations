...
export class ReservationService {
  ...
  async create(createReservationDto: CreateReservationDto, participantId: string): Promise<Reservation> {
  ...
  async updateStatus(id: string, updateStatusDto: UpdateReservationStatusDto, adminId?: string): Promise<Reservation> {
    ...
    if (reservation.status === ReservationStatus.REFUSED && status !== ReservationStatus.CONFIRMED) {
  ...
  async cancelByParticipant(id: string, participantId: string): Promise<Reservation> {
